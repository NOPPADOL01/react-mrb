...
goober.setup(React__default["default"].createElement);
const StyledCalendar = goober.styled(Calendar__default["default"]) `
  &.react-calendar,
  &.react-calendar *,
...
const formatDate = (date, locale) => {
    return dateFns.format(date, 'MM/dd/yyyy', { locale });
};
...
const ThemedButton = goober.styled('button') `
  padding: 16px;
  border: none;
...
`;
const StartTimeGridItemButton = goober.styled('button') `
  padding: 12px 16px;
  margin: 4px;
  border: none;
  color: white;
...
const Container$1 = goober.styled('div') `
  display: flex;
  width: 100%;
  align-items: center;
`;
const CancelButton = goober.styled('button') `
  padding: 8px 24px;
  border: none;
...
const StartTimeListItem = ({ confirmState, onStartTimeSelect, startTimeEvent, selected, onCancelClicked, borderRadius, primaryColor, primaryColorFaded, format_startTimeFormatString, lang_confirmButtonText, lang_cancelButtonText, lang_selectedButtonText, locale, }) => {
    return (React__default["default"].createElement(Container$1, { className: "rsm-start-time-item" },
        React__default["default"].createElement(ThemedButton, { type: "button", className: "rsm-confirm-button", selected: Boolean(selected || confirmState), borderRadius: borderRadius, primaryColorFaded: primaryColorFaded, primaryColor: primaryColor, onClick: onStartTimeSelect },
            confirmState && !selected && `${lang_confirmButtonText} `,
            selected && `${lang_selectedButtonText} `,
            dateFns.format(startTimeEvent.startTime, format_startTimeFormatString, { locale })),
        (confirmState || selected) && (React__default["default"].createElement(CancelButton, { type: "button", className: "rsm-cancel-button", borderRadius: borderRadius, onClick: onCancelClicked }, lang_cancelButtonText))));
};

const ScrollListContainer = goober.styled('div') `
  position: relative;
  display: flex;
  ...
  padding-top: 16px;
`;
const GridContainer = goober.styled('div') `
  position: relative;
  display: flex;
  flex-wrap: wrap;
  overflow-y: scroll;
...
`;
const ScrollEdgeFade = goober.styled('div') `
  position: absolute;
  width: 100%;
  height: 24px;
  left: 0;
...
`;
const ListItemDivider = goober.styled('div') `
  flex-shrink: 0;
  flex: 1;
  padding: 0.5px;
  margin: 0px 8px;
...
`;
const StyledP = goober.styled('p') `
  margin: 0;
  opacity: 0.5;
  margin-bottom: 24px;
  font-size: 18px;
`;
const NoTimesAvailableContainer = goober.styled('div') `
  height: 100%;
  flex: 1;
  width: 100%;
  display: flex;
  ...
  flex-direction: column;
`;
const GoToNextAvailableDayButton = goober.styled(ThemedButton) `
  border: none;
  padding: 6px 18px;
  width: auto;
  text-align: left;
...
`;
const NoFutureTimesText = goober.styled(StyledP) `
  font-size: 90%;
  font-weight: 700;
  padding: 3px 10px;
  border-radius: ${({ borderRadius }) => borderRadius}px;
...
`;
const StartTimeList = ({ skipConfirmCheck, selectedDay, selectedStartTime, startTimeListItems = [], onStartTimeSelect, emptyListContentEl, lang_emptyListText, borderRadius, primaryColorFaded, primaryColor, format_startTimeFormatString, lang_confirmButtonText, lang_cancelButtonText, lang_goToNextAvailableDayText, lang_noFutureTimesText, lang_selectedButtonText, onGoToNextAvailableDayClick, nextFutureStartTimeAvailable, format_nextFutureStartTimeAvailableFormatString, startTimeListStyle, setSelectedStartTime, locale, }) => {
        ...
        React__default["default"].createElement(React__default["default"].Fragment, null,
            ...
            nextFutureStartTimeAvailable ? (React__default["default"].createElement(GoToNextAvailableDayButton, { type: "button", selected: true, className: "rsm-next-available-date-button", borderRadius: borderRadius, primaryColorFaded: primaryColorFaded, primaryColor: primaryColor, onClick: onGoToNextAvailableDayClick },
                React__default["default"].createElement("p", null,
                    ...
                    dateFns.format(nextFutureStartTimeAvailable, format_nextFutureStartTimeAvailableFormatString, { locale })),
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null, startTimeListItems.length === 0 ? (emptyListElement) : startTimeListStyle === 'scroll-list' ? (React__default["default"].createElement(React__default["default"].Fragment, null,
        ...
        React__default["default"].createElement(ScrollListContainer, null, startTimeListItems.map((startTimeEvent, i) => (React__default["default"].createElement(React__default["default"].Fragment, { key: i },
            ...
            i !== startTimeListItems.length - 1 && (React__default["default"].createElement(ListItemDivider, { makeTransparent: selectedItemIndex === i || selectedItemIndex === i + 1 })))))))) : (React__default["default"].createElement(GridContainer, { className: selectedStartTime ? 'has-selection' : '' }, startTimeListItems.map((startTimeEvent, i) => (React__default["default"].createElement(StartTimeGridItemButton, { key: i, type: "button", className: selectedStartTime && selectedStartTime === startTimeEvent.startTime.getTime() ? 'is-selected' : '', primaryColorFaded: primaryColorFaded, borderRadius: borderRadius, primaryColor: primaryColor, onClick: () => onStartTimeSelect(startTimeEvent) }, dateFns.format(startTimeEvent.startTime, format_startTimeFormatString, { locale }))))))));
};

const Container = goober.styled('div') `
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: center;
`;
const Inner = goober.styled('div') `
  display: flex;
  border-radius: ${({ borderRadius }) => borderRadius}px;
...
`;
const Divider = goober.styled('div') `
  width: 1px;
...
`;
const CalendarContainer = goober.styled('div') `
  flex: 1;
`;
const StartTimeListContainer = goober.styled('div') `
  flex: 1;
  overflow: hidden;
  position: relative;
  @media (max-width: 768px) {
...
`;
const StartTimeListContainerAbsolute = goober.styled('div') `
  position: absolute;
  width: 100%;
  height: 100%;
  display: flex;
  flex-direction: column;
`;
const SelectedDayTitle = goober.styled('h3') `
  margin: 0;
  padding: 0;
  font-weight: 700;
  font-size: 24px;
`;
const Header = goober.styled('div') `
  width: 100%;
  display: flex;
  ...
  margin-bottom: 6px;
`;
const ArrowButton = goober.styled('button') `
  outline: none;
  background: none;
  border: none;
  border-radius: ${({ borderRadius }) => borderRadius}px;
...
const ScheduleMeeting = ({ selectedStartTime: _selectedStartTime, availableTimeslots = [], borderRadius = 0, primaryColor = '#3f5b85', emptyListContentEl, lang_emptyListText = 'No times available', eventStartTimeSpreadInMinutes = 0, eventDurationInMinutes = 30, onSelectedDayChange, onStartTimeSelect, scheduleMeetingStyles, defaultDate, format_selectedDateDayTitleFormatString = 'cccc, LLLL do', format_selectedDateMonthTitleFormatString = 'LLLL yyyy', format_startTimeFormatString = 'h:mm a', lang_confirmButtonText = 'Confirm', lang_cancelButtonText = 'Cancel', lang_noFutureTimesText = 'No future times available', lang_goToNextAvailableDayText = 'Next Available', lang_selectedButtonText = 'Selected:', format_nextFutureStartTimeAvailableFormatString = 'cccc, LLLL do', onNoFutureTimesAvailable, startTimeListStyle = 'grid', locale, skipConfirmCheck = false, }) => {
    ...
    const [selectedStartTime, setSelectedStartTime] = React__default["default"].useState(_selectedStartTime ? _selectedStartTime.getTime() : undefined);
        ...
        React__default["default"].createElement(Inner, { borderRadius: borderRadius, style: scheduleMeetingStyles },
            React__default["default"].createElement(CalendarContainer, null,
                React__default["default"].createElement(Header, null,
                    ...
                    React__default["default"].createElement(SelectedDayTitle, { className: "rsm-date-title" }, dateFns.format(selectedDay, format_selectedDateMonthTitleFormatString, { locale })),
                ...
                React__default["default"].createElement(ScheduleCalendar, { locale: locale, borderRadius: borderRadius, primaryColor: primaryColorRGB, selectedDay: selectedDay, availableTimeslots: orderedAvailableTimeslots, primaryColorFaded: primaryColorFaded, onDaySelected: onDaySelected })),
                ...
                React__default["default"].createElement(StartTimeListContainerAbsolute, null,
                    React__default["default"].createElement(Header, null,
                        React__default["default"].createElement(ArrowButton, { type: "button", className: "rsm-arrow-button", borderRadius: borderRadius, onClick: goToPreviousDay },
                            React__default["default"].createElement(Arrow, { direction: "back" })),
                        React__default["default"].createElement(SelectedDayTitle, { className: "rsm-date-title" }, dateFns.format(selectedDay, format_selectedDateDayTitleFormatString, { locale })),
